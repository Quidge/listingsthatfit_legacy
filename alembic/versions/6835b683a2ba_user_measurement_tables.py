...
def upgrade():
	...
	op.create_table(
		'measurement_item_category',
		sa.Column('measurement_item_category_id', sa.Integer, primary_key=True),
		sa.Column('measurement_item_category_name', sa.Text, unique=True, nullable=False))
	op.create_table(
		'measurement_item_type',
		sa.Column('measurement_item_type_id', sa.Integer, primary_key=True),
		sa.Column('measurement_item_type_name', sa.Text, unique=True, nullable=False))
	op.create_table(
	...
	op.create_unique_constraint(
		'uq_table_ebay_item_category_id_measurement_item_category_id_measurement_item_type_id_user_account_id',
		'user_measurement_preference',
		[
			'ebay_item_category_id',
			'measurement_item_category_id',
...
def downgrade():
	...
	op.drop_table('measurement_item_category')
	op.drop_table('measurement_item_type')
